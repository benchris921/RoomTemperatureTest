...
//        theta += Math.PI/2.0;
    ...
    public void  setDrawingAngle(@IntRange(from = 0, to = 360) int _drawingAngle) {
        mDrawingAngle = _drawingAngle;
    }
    ...
    private void parseAttributes(TypedArray a) {
        ...
        setDrawingAngle(a.getInt(R.styleable.CircleProgressView_cpv_drawingAngle, mDrawingAngle));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mRimWidth > 0) {
            if (!mShowBlock) {
                ...
                drawBlocks(canvas, mCircleBounds, mStartAngle, mDrawingAngle, false, mRimPaint);
            }
        }
